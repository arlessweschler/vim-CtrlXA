function! CtrlXA#localization#init(spelllang) abort
  let lang = matchstr(a:spelllang,'^\a\a')
  ...
  if lang =~# '\<pt\>'
    let LocalizedToggles += [
          ...
          \ ['Zero', 'Um', 'Dois', 'Três', 'Quatro', 'Cinco', 'Seis', 'Sete', 'Oito', 'Nove', 'Dez', 'Onze', 'Doze'],
          \ ['primeiro', 'segundo', 'terceiro', 'quarto', 'quinto', 'sexto', 'sétimo', 'oitavo', 'nono', 'décimo', 'décimo primeiro', 'décimo segundo'],
          \ ['Primeiro', 'Segundo', 'Terceiro', 'Quarto', 'Quinto', 'Sexto', 'Sétimo', 'Oitavo', 'Nono', 'Décimo', 'Décimo Primeiro', 'Décimo Segundo'],
          \
  ...
  if lang =~# '\<ro\>'
    let LocalizedToggles += [
          ...
          \ ['Zero', 'Unu', 'Doi', 'Trei', 'Patru', 'Cinci', 'Șase', 'Șapte', 'Opt', 'Nouă', 'Zece', 'Unsprezece', 'Doisprezece'],
          \ ['primul', 'al doilea', 'al treilea', 'al patrulea', 'al cincilea', 'al șaselea', 'al șaptelea', 'al optulea', 'al nouălea', 'al zecelea', 'al unsprezecelea', 'al doisprezecelea'],
          \ ['Primul', 'Al doilea', 'Al treilea', 'Al patrulea', 'Al cincilea', 'Al șaselea', 'Al șaptelea', 'Al optulea', 'Al nouălea', 'Al zecelea', 'Al unsprezecelea', 'Al doisprezecelea'],
          \
  ...
  let b:CtrlXA_Toggles = LocalizedToggles + get(b:, 'CtrlXA_Toggles', [])
endf
